        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">{{$institution->name}} الصلاحيات</h3>
...
<tr>
  {{-- {{ dd($permission)}} --}}
    ...
    <td> <div class="icheck-primary d-inline">
        <input onchange="updateInstitutionPermission({{$institution->id}},{{ $permission->id}})" type="checkbox"  id="permission_{{$permission->id}}" @if($permission->assigned) checked @endif >
...
@section('scripts')
<script>
function updateInstitutionPermission(institutionId,permissionId){
        axios.post('/admin/institutions/'+institutionId+'/permissions/',{
